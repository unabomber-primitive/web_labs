...
function createRectangle(R) {
    let p1 = createPoint(0, 0);
    let p2 = createPoint(R/2, 0);
    let p3 = createPoint(R/2, -R);
...
function createCircle(R) {
    ...
    let p2 = createPoint(0, -R/2, false);
    let p3 = createPoint(-R/2, 0, false);
    return board.create('sector', [p1, p3, p2], figuresProperties);
}
...
function onChangeRValue() {
    let R = app.validateR(app.getRValue().trim(), false);
